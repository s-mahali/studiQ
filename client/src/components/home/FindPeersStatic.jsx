...
const FindPeersStatic = ({ className }) => {
  ...
  const visibleUsers = () => {
    ...
    if (end <= users.length) {
      ...
      return [
        ...users.slice(start),
        ...users.slice(0, end - users.length),
      ];
    }
  };
                    ...
                    <div className="h-full bg-gradient-to-b from-slate-800 to-slate-900 border border-slate-700/50 rounded-xl overflow-hidden shadow-lg hover:shadow-cyan-900/20 hover:shadow-xl transition-all ">
                      ...
                      <div className="p-6 flex flex-col items-center">
                        ...
                        <div className="mb-4">
                          ...
                          >
                            {user.proficiency.charAt(0).toUpperCase() +
                              user.proficiency.slice(1)}
                          </Badge>
                        </div>
                        {/* Subjects */}
                        ...
                        <div className="w-full flex gap-2">
                          ...
                          >
                            <Link to="/login">
                              <Button className="w-full bg-gradient-to-r from-cyan-600 to-teal-600 hover:from-cyan-500 hover:to-teal-500 transition-all shadow-md hover:shadow-lg hover:shadow-cyan-900/30 cursor-pointer">
...
export default FindPeersStatic;
